...
describe('EventForm', () => {
  ...
  describe('Validação', () => {
    ...
    test('exibe erro quando nome excede 100 caracteres', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);
    ...
    test('exibe erro quando data está vazia', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);
    ...
    test('exibe erro quando data é no passado', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);
    ...
    test('exibe erro quando local está vazio', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);
    ...
    test('exibe erro quando local excede 200 caracteres', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);
    ...
    test('exibe erro quando número de participantes está vazio', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);
    ...
    test('exibe erro quando número de participantes é menor que 1', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);
    ...
    test('exibe erro quando número de participantes excede 50', () => {
      render(<EventForm onSubmit={mockOnSubmit} />);

      const participantsInput = screen.getByLabelText(/número estimado de pessoas/i);
      
      fireEvent.change(participantsInput, { target: { value: '51' } });
      fireEvent.click(screen.getByRole('button', { name: /criar evento/i }));
